...
function multiplicarArgumentos() {
   ...
   // Tu código:
   var total = 1
   for (var elementos of arguments) {
      total= total * elementos
   }
   return total 
  }
  console.log(multiplicarArgumentos(3,1,4))
...
console.log(cuentoElementos([1,2,3,4,5,20,19]))
...
function todosIguales(array) {
   ...
   // Tu código:
   var elementodereferencia = array[0]
   return array.every(function(num){
      return num===elementodereferencia 
   })
}
...
function mayorACien(array) {
   // La función recibe un arreglo con enteros entre 0 y 200.var i =
